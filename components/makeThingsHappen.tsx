    ...
    <section className="relative w-full overflow-visible mt-10 mb-36">
      ...
      <div className="bg-[#D11417] w-full">
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="relative flex flex-col md:flex-row items-center justify-center h-[300px] md:h-[220px] lg:h-[260px]">
            
            {/* Left circular image  */}
<div
  className="hidden md:block absolute left-10 top-1/2 -translate-y-1/2"
  style={{ width: 300, height: 300, marginLeft: -130 }} // bigger size
>
...
<div
  ref={chiliRef}
  className="absolute right-0 -top-[25%] -translate-y-1/2 pointer-events-none" // moved up
...
>
  ...
  />
            ...
            {/* Content block */}
            <div className="relative z-20 flex flex-col items-center md:items-start text-center md:text-left text-white px-4 md:px-6 mx-auto md:mx-0 max-w-lg lg:max-w-xl">
              {/* Heading */}
              <h1
              ...
              {/* Paragraph */}
              <p
                className="mt-4 text-[16px] leading-6 text-[#FAFAFA] max-w-full"
                style={{ opacity: 1 }}
              >
